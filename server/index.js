...
app.get('/api/nearby', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                data = _a.sent();
                return [4 /*yield*/, utils_1.addPictureToResponsefrom(data, '../mock_db/hornsgatan.json')];
            case 2:
                data = _a.sent();
...
app.get('/api/nearby/:city', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                data = _a.sent();
                return [4 /*yield*/, utils_1.addPictureToResponsefrom(data, '../mock_db/stockholm.json')];
            case 3:
                data = _a.sent();
                return [3 /*break*/, 7];
...
app.delete('/api/users/reviews/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var reviewId, cookie;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                cookie = req.cookies.user_id;
                return [4 /*yield*/, dbUtils_1.deleteReviewBookmark(reviewId, cookie, 'reviews')];
            case 1:
                _a.sent();
                res.status(204).end();
                return [2 /*return*/];
...
app.delete('/api/users/bookmarks/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var bookmarkId, cookie;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                bookmarkId = req.params.id;
                cookie = req.cookies.user_id;
                return [4 /*yield*/, dbUtils_1.deleteReviewBookmark(bookmarkId, cookie, 'bookmarks')];
            case 1:
                _a.sent();
                res.status(204).end();
                return [2 /*return*/];
